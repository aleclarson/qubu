...
| Read queries       | Projections, wildcards, aliases, joins, `WHERE`, grouping, `HAVING`, ordering, window expressions, distinctness, pagination, CTEs, subqueries, and set operations |
