...
| Read queries       | Projections, wildcards, aliases, joins, `WHERE`, grouping, `HAVING`, ordering, distinctness, pagination, CTEs, subqueries, and set operations |
| Expressions        | Comparison, boolean, arithmetic, null, range, membership, aggregate, string, cast, case, and custom expressions                               |
