...
| ------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Schema values      | `table`, immutable `schema` registries with namespaces, named primary, unique, foreign-key, and check constraints, portable column/expression/partial/unique indexes, and typed column helpers                                                                                   |
