...
| Execution boundary | `QueryAdapter`, bound `QubuClient` values from `qubu()`, structured results from `execute()` or `db.execute()`, and row-only results from `executeRows()` or `db.rows()`                                                                                                                                                                                                     |
