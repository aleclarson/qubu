...
| `qubu/diff`                               | Runtime          | Canonical Snapshot v2 comparison, rename hints, suggestions, and safety diagnostics                              |
| `qubu/introspection`                      | Runtime          | Shared catalog contracts, normalized catalog models, diagnostics, and mapping to Snapshot v2                    |
...
| `qubu/snapshot`                           | Runtime          | Canonical Snapshot v2 traversal, encoding, decoding, diagnostics, and fingerprints                              |
...
| Snapshots            | Pure Snapshot v2 creation, canonical encoding and strict decoding, immutable data, diagnostics, and FNV change-detection fingerprints                                                                                                                                                                                                                                           |
...
| Snapshot diffing     | Pure Snapshot v2 comparison, explicit rename evidence, non-authoritative suggestions, and safety diagnostics                                                                                                                                                                                                                                                                            |
...
| Source generation    | Pure Snapshot v2 table source printing, deterministic camelCase IDs, exact physical metadata, controlled type mappings, and structured failure diagnostics                                                                                                                                                                                                                             |
...
| Schema source generation | Prints deterministic TypeScript from complete, non-lossy Snapshot v2 introspection without writing files                                                                                                                                                                     | Owns generated-file writes, replacement policy, hand-edit merging, and CLI integration                                                                                                                                                                                       |
