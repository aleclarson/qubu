...
/**
 * Lower a reviewed plan into its authoritative, versioned execution program.
 * Policy is operation-scoped: broad unsafe renderer flags are deliberately unavailable here.
 */
