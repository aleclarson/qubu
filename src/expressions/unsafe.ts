...
export function unsafeExpression<T = unknown, TSqlType extends AnySqlType = SqlUnknown>(
  sql: string,
): Expression<ResultMeta<T, never, TSqlType> | ExpressionMeta<never>, "unsafe"> {
  return makeExpression<ResultMeta<T, never, TSqlType> | ExpressionMeta<never>, "unsafe">(
    "unsafe",
