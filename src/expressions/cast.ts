...
import { makeSchemaExpression, type AnyExpression, type ResultExpression } from "./types.ts"
 ...
 */
export function cast<TDefinition extends CastDefinition, TExpression extends AnyExpression>(
...
export function cast(
  ...
  >(
    ...
    (context) => {
      ...
      context.append(" AS ")
      context.append(
        typeof target === "string" ? target : resolveCastTarget(context.dialect, target.castTarget),
      )
      context.append(")")
    },
