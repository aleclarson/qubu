...
function jsonScalar<TOutput, TDocument extends AnyExpression, TPath extends JsonPath>(
  document: TDocument,
  path: TPath,
  kind: "text" | "number" | "boolean",
) {
  return makeSchemaExpression<JsonExpressionMetadata<TOutput | null, TDocument>, "function">(
    "function",
    (context) => {
...
export function jsonText<TDocument extends AnyExpression, TPath extends JsonPath>(
  document: TDocument,
  path: TPath,
) {
...
export function jsonNumber<TDocument extends AnyExpression, TPath extends JsonPath>(
  document: TDocument,
  path: TPath,
) {
...
export function jsonBoolean<TDocument extends AnyExpression, TPath extends JsonPath>(
  document: TDocument,
  path: TPath,
) {
...
export function jsonExists<TDocument extends AnyExpression, TPath extends JsonPath>(
  document: TDocument,
  path: TPath,
) {
  return makeSchemaExpression<JsonExpressionMetadata<boolean, TDocument>, "function">(
    "function",
    (context) => {
      assertDialectCapability(context.dialect, "json")
      if (!context.dialect.json) {
