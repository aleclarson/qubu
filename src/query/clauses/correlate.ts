...
> extends SelectClause<
    ProvidesOuterSourceMeta<SourceIdentity<TSources[number]>>
  > {
...
>(...sources: TSources): CorrelateClause<TSources> {
  return Object.assign(
    ...
    { clauseKind: 'correlate' as const, sources }
