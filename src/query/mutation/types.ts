...
import type { ReturningClause, ReturningRow, ReturningSqlTypes } from "./returning.ts"
...
type MutationConfigValue<TConfig, TKey extends PropertyKey, TFallback> = TKey extends keyof TConfig
  ? TConfig[TKey]
  : TFallback
...
export interface MutationQuery<TConfig extends MutationQueryConfig = {}> extends Query<{
...
export type MutationSqlTypes<TClauses extends readonly unknown[]> = ReturningSqlTypes<
  MutationReturning<TClauses>
>

export type MutationScopeValidation<TSource, TClauses extends readonly unknown[]> = [
