...
export function hasIntrospectionErrors(diagnostics: readonly IntrospectionDiagnostic[]): boolean {
...
function freezeDiagnostic(diagnostic: IntrospectionDiagnostic): IntrospectionDiagnostic {
  return Object.freeze({
    ...
    relatedReferences: diagnostic.relatedReferences
      ? Object.freeze(diagnostic.relatedReferences.map((reference) => freezeReference(reference)))
      : undefined,
  })
}
...
function freezeReference(reference: CatalogReference): CatalogReference {
  return Object.freeze({
    ...reference,
    catalog: reference.catalog ? Object.freeze({ ...reference.catalog }) : undefined,
  })
}
