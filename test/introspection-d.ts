...
expectTypeOf(rows).toEqualTypeOf<Promise<readonly { readonly schemaName: string }[]>>()
...
expectTypeOf(expression.provenance.kind).toEqualTypeOf<"catalog" | "decompiler" | "create-sql">()
...
expectTypeOf(sqliteDeferred.dialect).toEqualTypeOf<CatalogDialectExtension | undefined>()
