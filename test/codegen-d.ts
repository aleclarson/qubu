...
expectTypeOf<
  ColumnOutput<typeof accountEntries.definitions.status>
>().toEqualTypeOf<unknown>()
expectTypeOf<
  ColumnInsertInput<typeof accountEntries.definitions.status>
>().toEqualTypeOf<unknown>()
expectTypeOf<
  ColumnUpdateInput<typeof accountEntries.definitions.status>
>().toEqualTypeOf<unknown>()
...
expectTypeOf(
  nonNullUnknown.indexes.candidate.candidateKey
).toEqualTypeOf<true>()

table(
  'nullable_unknown_primary',
...
expectTypeOf(
  nullableUnknownIndex.indexes.uniqueIndex.candidateKey
).toEqualTypeOf<false>()
