...
import type { QubuExplainableClient, QubuExplainableTransactionalClient } from "../src/execution.ts"
...
db.transaction(async (transaction) => {
  expectTypeOf(transaction).toEqualTypeOf<QubuExplainableClient<LibsqlTransactionAdapter>>()
