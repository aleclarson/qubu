...
expectTypeOf(accounts.constraints.nullableCodeUnique.nulls).toEqualTypeOf<"not-distinct">()
expectTypeOf(accounts.constraints.nullableCodeUnique.kind).toEqualTypeOf<"unique-constraint">()
expectTypeOf(accounts.constraints.accountsPrimary.physicalName).toEqualTypeOf<string | undefined>()
expectTypeOf(accounts.indexes.codeIndex.includedColumns).toEqualTypeOf<
  readonly [typeof accounts.nullableCode] | undefined
>()
expectTypeOf(accounts.indexes.codeIndex.dialect).toMatchTypeOf<IndexDialectExtension | undefined>()
...
table("typed_constraint_invalid_unique", { nullableCode: text({ nullable: true }) }, (invalid) => ({
  constraints: {
