...
expectTypeOf<ColumnDefaultOf<typeof literalDefault>>().toMatchTypeOf<LiteralDefaultDescriptor>()
...
expectTypeOf<ColumnIdentityOf<typeof identity>>().toEqualTypeOf<IdentityDescriptor>()
expectTypeOf<ColumnDefaultOf<typeof legacyDefault>>().toEqualTypeOf<ExternalDefaultDescriptor>()
expectTypeOf<
